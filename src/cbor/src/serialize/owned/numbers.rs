...
pub fn usmall(v: u8) -> OwnedValue {
    if v < 24 {
        OwnedValue::simple(MajorType::UnsignedInteger(MinorType::SameByte(v)))
    } else {
        OwnedValue::simple(MajorType::UnsignedInteger(MinorType::SameByte(23)))
    }
}

pub fn u8(v: u8) -> OwnedValue {
    OwnedValue::simple(MajorType::UnsignedInteger(MinorType::OneByte(v)))
}

pub fn u16(v: u16) -> OwnedValue {
    OwnedValue::simple(MajorType::UnsignedInteger(MinorType::TwoBytes(v)))
}

pub fn u32(v: u32) -> OwnedValue {
    OwnedValue::simple(MajorType::UnsignedInteger(MinorType::FourBytes(v)))
}

pub fn u64(v: u64) -> OwnedValue {
    OwnedValue::simple(MajorType::UnsignedInteger(MinorType::EightBytes(v)))
}

pub fn uint(v: u64) -> OwnedValue {
    if v < 24 {
        usmall(v as u8)
    } else if v <= 0xFF {
        u8(v as u8)
...
/// -1.
pub fn negative_usmall(v: u8) -> OwnedValue {
    if v < 24 {
        OwnedValue::simple(MajorType::NegativeInteger(MinorType::SameByte(v)))
    } else {
        OwnedValue::simple(MajorType::NegativeInteger(MinorType::SameByte(23)))
    }
}
...
pub fn negative_u8(v: u8) -> OwnedValue {
    OwnedValue::simple(MajorType::NegativeInteger(MinorType::OneByte(v)))
}
...
/// function encodes the number as is, e.g. `negative_i8(200)` is actually encoding -201.
pub fn negative_u16(v: u16) -> OwnedValue {
    OwnedValue::simple(MajorType::NegativeInteger(MinorType::TwoBytes(v)))
}
...
/// function encodes the number as is, e.g. `negative_i8(200)` is actually encoding -201.
pub fn negative_u32(v: u32) -> OwnedValue {
    OwnedValue::simple(MajorType::NegativeInteger(MinorType::FourBytes(v)))
}
...
/// function encodes the number as is, e.g. `negative_i8(200)` is actually encoding -201.
pub fn negative_u64(v: u64) -> OwnedValue {
    OwnedValue::simple(MajorType::NegativeInteger(MinorType::EightBytes(v)))
}
...
/// function encodes the number as is, e.g. `negative_i8(200)` is actually encoding -201.
pub fn negative_uint(v: u64) -> OwnedValue {
    if v < 24 {
